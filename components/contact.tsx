                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Rudrapur , India </p>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="pt-6">
                ...
                <div className="flex space-x-4">
                  <Button variant="outline" size="icon" asChild>
                    <a
                      href="https://github.com/vinay9870990"
                      target="_blank"
                  ...
                  <Button variant="outline" size="icon" asChild>
                    <a
                      href="https://www.linkedin.com/in/vinay-pathak-876bb41b5/"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="LinkedIn"
                    >
